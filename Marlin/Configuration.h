...
#define CUSTOM_MACHINE_NAME "3018 CNC"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 800, 800, 800} // to suit S42B with 1/8 mictostepping
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 25, 25, 25 }
...
#define HOMING_FEEDRATE_MM_M { (16*60), (16*60), (16*60) }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    PA9        // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
